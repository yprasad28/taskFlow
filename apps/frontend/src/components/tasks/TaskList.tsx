...
export function TaskList() {
  ...
  const totalPages = data?.pagination ? Math.ceil(data.pagination.total / (filters.limit || 10)) : 1;
          ...
          {isLoading ? (
            ...
            <>
              <div className="rounded-lg border border-border">
                <div className="grid grid-cols-[auto_1fr_auto_auto_auto_auto] items-center gap-4 border-b border-border bg-muted/50 px-4 py-3 text-sm font-medium text-muted-foreground">
                  <div className="w-5" />
                  <div>Task</div>
                ...
                {data.items.map((task: Task) => (
                  <div
                    key={task.id}
                    className="flex items-center gap-4 border-b border-border px-4 py-4 last:border-0 hover:bg-muted/50 transition-colors"
                  >
                    <input
                      type="checkbox"
