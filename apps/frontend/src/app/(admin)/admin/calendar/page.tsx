...
export default function AdminCalendarPage() {
  ...
  const [selectedDate, setSelectedDate] = useState<Date | null>(new Date(2026, 5, 14));
  ...
  const fetchTasks = useCallback(async () => {
    try {
      setLoading(true);
      const { data } = await api.get("/admin/tasks?limit=50&sortBy=dueDate&sortOrder=asc");
    ...
    <div className="relative">
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400">
          View and manage task deadlines across your team.
        </p>
      </div>
      ...
      <div className="flex flex-wrap items-center justify-end mb-6 gap-2">
        <select
          ...
          className="h-9 rounded-lg border border-gray-200 bg-white px-3 text-sm text-gray-700 focus:border-[#2170e4] focus:outline-none dark:border-white/10 dark:bg-[#0d1520] dark:text-white"
        >
        ...
        >
          ...
          <option value="v3">V3 Release</option>
          <option value="api">API Platform</option>
        </select>
      </div>

      <div className="mb-6 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3 sm:gap-4">
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/10 dark:bg-[#111827]">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-[10px] font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400">In Review</p>
              <p className="text-xl font-bold text-green-600">{stats.inReview}</p>
            </div>
          </div>
        </div>
        <div className="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/10 dark:bg-[#111827]">
        ...
        <div className="w-full lg:w-[280px] shrink-0 space-y-4">
          ...
          <div className="rounded-xl border border-gray-200 bg-white p-4 dark:border-white/10 dark:bg-[#111827]">
            <h3 className="mb-3 text-sm font-semibold text-gray-900 dark:text-white">
              Focused Task: {selectedDate ? moment(selectedDate).format("MMM D") : "Select a date"}
            </h3>
                ...
                {selectedDateTasks.map((task) => (
                  ...
                  >
                    ...
                    <div className="mt-2 flex items-center gap-2">
                      <div className="flex h-5 w-5 items-center justify-center rounded-full bg-[#0b1c30] text-[8px] font-medium text-white">
